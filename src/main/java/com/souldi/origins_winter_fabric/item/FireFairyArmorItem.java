...
import com.souldi.origins_winter_fabric.client.renderer.FireFairyArmorRenderer;
...
public class FireFairyArmorItem extends ArmorItem implements GeoItem {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
    private final Supplier<Object> renderProvider = GeoItem.makeRenderer(this);

    public FireFairyArmorItem(ArmorMaterial mat, Type type, Settings s){super(mat, type, s);}

    @Override public void createRenderer(Consumer<Object> cons){
        cons.accept(new RenderProvider(){
            private FireFairyArmorRenderer renderer;
            @Override public BipedEntityModel<LivingEntity> getHumanoidArmorModel(LivingEntity e, ItemStack st, EquipmentSlot sl, BipedEntityModel<LivingEntity> orig){
                if(renderer==null)renderer=new FireFairyArmorRenderer();
